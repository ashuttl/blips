...
class Sim:
    ...
    def _flow_tick(self, dt):
        ...
        # a field with one ILS keeps landing on it: where the plates know
        # the field and the other flow would put arrivals on a runway end
        # with less approach than this one has, the wind only shifts in
        # place — the real calm-wind preference of a one-ILS airport
