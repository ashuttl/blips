...
lat/lon — the basemap and radar stay aligned.
...
def librewxr_provider(color):
    ...
    base = os.environ.get("BLIPS_LIBREWXR_URL", LIBREWXR_DEFAULT_URL)
...
def reproject(provider, host, path, bbox, w, h, timeout=15, mutable=False):
    ...
    Returns (w, h, bytearray) — same shape decode_rgba yields.
    """
